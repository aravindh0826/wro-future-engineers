...
--source to use a webcam or a recorded video file instead.

Usage:
    python lens_calibrator.py                 # Pi Camera (on a real Pi)
    python lens_calibrator.py --source 0       # webcam index 0
"""
