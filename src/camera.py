...
def _detect_pi():
    """
    Detects actual Raspberry Pi hardware, not just 'any Linux machine'
    (platform.system() == 'Linux' is also true on dev laptops/containers
    running Linux, which would wrongly try to import picamera2/RPi.GPIO
    and crash there).
    """
    try:
